...
<div class="clazz">
    ...
    <el-row>
        <el-table :data="clazzList.rows" stripe border="" style="width: 100%">
            ...
            <el-table-column width="100" label="学科">
            ...
            <el-table-column width="100" label="学期">
                <template slot-scope="scope">
            {{scope.row.term}}
          </template>
            </el-table-column>
            <el-table-column width="120" label="班型">
                <template slot-scope="scope">
            ...
            <el-table-column width="120" label="开课日期">
                <template slot-scope="scope">
            {{scope.row.begin_date}}——{{scope.row.finish_date}}
          </template>
            </el-table-column>
            <el-table-column width="120" label="上课时间">
                <template slot-scope="scope">
            {{scope.row.class_begin_time}}——{{scope.row.class_finish_time}}
          </template>
            </el-table-column>
            <el-table-column width="120" label="上课地点">
                <template slot-scope="scope">
            {{scope.row.classroom_id}}
          </template>
            </el-table-column>
